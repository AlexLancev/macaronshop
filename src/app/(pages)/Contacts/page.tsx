					...
					<div className="mb-6">
						...
						<div>
							<a
								...
								>(812) 309-82-88 <span className="text-gray-500">(ежедневно, с 9 до 18)</span>
							</a>
							<a
							...
							<span className="text-gray-500 text-sm">— для пожеланий и предложений</span>
						</div>
					</div>
					...
					<div className="mb-6">
						...
						<div>
							<a
								href="tel:88123098288"
								className="block text-base mb-1"
								>(812) 309-82-88 <span className="text-gray-500">(доб. 2)</span>
							</a>
							<a
							...
							<span className="text-gray-500 text-sm block">Пн–Пт (9:00 – 18:00)</span>
						</div>
					</div>

					<div>
						<div className="font-semibold mb-1">Отдел по работе с сетями:</div>
						<a
							href="mailto:ak@macaronshop.ru"
							className="block text-base"
							style={{ color: "var(--color-customBlue)" }}
